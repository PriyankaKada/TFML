...
public class Constant {
    ...
    public static final String COMPLAINT_BASE_TEMP =  "http://rocuat.tmf.co.in/";
    ...
    public static final String REFERFRIEND = "customer/referFriend";
    ...
    public static final String MYCONTRACT = "customer/myContracts";
