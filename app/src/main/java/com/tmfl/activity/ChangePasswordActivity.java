            ...
            case R.id.btn_change_password:
                if (CommonUtils.isNetworkAvailable(ChangePasswordActivity.this)) {
                    if (TextUtils.isEmpty(txtOldpass.getText().toString())) {
                        ...
                        Log.e("ChangePassword", "onClick: " + "UserId:" + PreferenceHelper.getString(PreferenceHelper.USER_ID));
                        Log.e("ChangePassword", "onClick: " + "setOld_password:" + txtOldpass.getText().toString());
                        Log.e("ChangePassword", "onClick: " + "setNew_password:" + txtNewPass.getText().toString());
                        Log.e("ChangePassword", "onClick: " + "Access_token:" + PreferenceHelper.getString(PreferenceHelper.API_TOKEN));
